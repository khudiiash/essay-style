let replace = [
    { '(?<!the United States of )America':'the US["America" might be vague. If you mean the country, please replace.]'},
    { 'appear to be' : 'are'},
    { 'appears to be' : 'is'},
    { 'appeared to be' : 'was'},
    ...
    { 'compile' : 'collect' },{ 'compiles':'collects' }, { 'compiled' : 'collected'},{'compiling':'collecting'},
    ...
    { 'in the process of' : 'in,while[This phrase might be unnecessarily wordy]'},
    ...
    { 'good' : 'positive,excellent,satisfactory' },
    { 'bad' : 'negative,atrocious,unacceptable' },
    ...
    { 'try' : 'attempt,test,seek'},
    { 'tries' : 'attempts,tests,seeks'},
    { 'tried' : 'attempted,tested,seeked'},
    { 'trying' : 'attempting,testing,seeking'},
    { 'just' : 'barely,only,hardly'},
    {'like':'such as,similar to,wish'},
    ...
    {'(?<!a |the )right':'correct,appropriate,suitable'},
